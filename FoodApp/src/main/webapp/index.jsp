...
<head>
    ...
    <style>
        ...
        .form {
            ...
            gap: 10px;
            padding: 1.5em; /* Adjusted padding for a smaller form */
            background-color: #171717;
            border-radius: 15px; /* Slightly smaller border radius for a more compact look */
            transition: .4s ease-in-out;
            max-width: 300px; /* Set a maximum width to make the form smaller */
            width: 100%;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Optional shadow for better focus */
        }
        ...
        .form .btn {
            ...
            justify-content: center;
            flex-direction: row;
            margin-top: 1.5em; /* Reduced margin-top */
        }
        ...
        /* Ensure the <a> tag inside button2 and button3 looks correct */
        .button2 a, .button3 a {
            color: white;
            text-decoration: none;
            display: block; /* Ensure the <a> tag covers the entire button */
            width: 100%;
            height: 100%;
...
<body>
    <form class="form" action="login">
        ...
        <div class="btn">
            ...
            <a href="register.jsp" class="button2">Sign Up</a>
        </div>
        <a href="forgot-password.jsp" class="button3">Forgot Password</a>
    </form>
</body>
</html>
